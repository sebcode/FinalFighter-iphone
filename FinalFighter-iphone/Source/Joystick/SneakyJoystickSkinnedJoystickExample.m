...
- (id) init
{
	self = [super init];
	if(self != nil){
		self.backgroundSprite = [ColoredCircleSprite circleWithColor:ccc4(0, 0, 0, 50) radius:100];
		self.thumbSprite = [ColoredCircleSprite circleWithColor:ccc4(255, 255, 255, 50) radius:30];
